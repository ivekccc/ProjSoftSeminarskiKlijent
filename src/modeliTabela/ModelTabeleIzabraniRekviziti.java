 ...
 * @author x
 */
public class ModelTabeleIzabraniRekviziti extends AbstractTableModel {

    private List<Rekvizit> listaRekvizita=new ArrayList<>();
    private final String[] kolone={"tip","naziv","marka","zaduzena_kolicina"};
    
    public ModelTabeleIzabraniRekviziti(List<Rekvizit> listRekvizita) {
        this.listaRekvizita=listRekvizita;
    }

    public ModelTabeleIzabraniRekviziti() {
    }
